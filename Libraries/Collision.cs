...
namespace Quarter4Project.Libraries
{
    public static class Collision
    {
        ...
        public static float GetAngle(Vector2 v, Vector2 u)
        {
            float a = dotProduct(v, u);
            float b = (magnitude(v) * magnitude(u));
        ...
        public static Vector2 DegreesToVector(float a)
        {
            MathHelper.ToRadians(a);
